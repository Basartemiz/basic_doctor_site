...
import './DiseaseHero.css'

function DiseaseHero({ disease, service, breadcrumbs }) {
  return (
    <section className="disease-hero">
      <div className="container">
        <Breadcrumb items={breadcrumbs} />
        <div className="disease-hero-content">
          <span className="disease-category">{service?.title}</span>
          <h1>{disease.title}</h1>
          <p className="disease-subtitle">{disease.subtitle}</p>
