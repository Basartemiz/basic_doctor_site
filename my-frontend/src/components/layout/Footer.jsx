      ...
      <div className="container footer-grid">
        <div>
          ...
          <div className="footer-contact-info">
            <a href="tel:+905304228035" className="footer-phone">
        ...
        <div className="footer-links">
          <h4 className="footer-heading">Hizli Erisim</h4>
        ...
        <div className="footer-links">
          <h4 className="footer-heading">Uzmanlik Alanlari</h4>
          <Link to="/hizmetler/kbb">KBB Hastaliklari</Link>
          <Link to="/hizmetler/cerrahi">Cerrahi Mudahaleler</Link>
          <Link to="/hizmetler/estetik">Medikal Estetik</Link>
        </div>
        <div className="footer-social">
          <h4 className="footer-heading">Bizi Takip Edin</h4>
          <div className="social-links">
            <a
              href="https://www.instagram.com/drbanubegen"
              target="_blank"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp'tan ulasin"
              className="social-link"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24" aria-hidden="true">
          ...
          <p className="footer-address">
            1721 Sk. No: 19 Daire 3<br />
            Donanimaci Mah., Karsiyaka/Izmir
          </p>
        </div>
      </div>
